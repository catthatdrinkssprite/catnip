...
local Library do
    ...
    Library = {
        ...
        Images = { -- you're welcome to reupload the images and replace it with your own links
            ["Saturation"] = {"Saturation.png", "https://github.com/catthatdrinkssprite/moonshine/blob/main/libraries/kiwisense/images/saturation.png?raw=true" },
            ["Value"] = { "Value.png", "https://github.com/catthatdrinkssprite/moonshine/blob/main/libraries/kiwisense/images/value.png?raw=true" },
            ["Hue"] = { "Hue.png", "https://github.com/catthatdrinkssprite/moonshine/blob/main/libraries/kiwisense/images/horizontalhue.png?raw=true" },
            ["Checkers"] = { "Checkers.png", "https://github.com/catthatdrinkssprite/moonshine/blob/main/libraries/kiwisense/images/checkers.png?raw=true" },
        },
    ...
    local CustomFont = { } do
        ...
        CustomFont:New("Inter", 200, "Regular", {
            Url = "https://github.com/catthatdrinkssprite/moonshine/raw/refs/heads/main/libraries/kiwisense/fonts/InterSemibold.ttf"
        })
